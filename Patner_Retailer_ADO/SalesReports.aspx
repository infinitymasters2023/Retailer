...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="card">
        <div class="card-body">
            <h5 class="card-header mb-3" style="display: flex; justify-content: space-between; padding-top: 0px !important; padding-left: 0px !important;">Sales Reports</h5>
                ...
                <div class="row" style="width: 100%;">
                    ...
                    <div class="col-12 col-lg-2 mb-2 mb-lg-2">
                        ...
                        <asp:TextBox runat="server" CssClass="form-control" ID="txtMobileNo"
                           oninput="validateMobileNumber(this)"   placeholder="Mobile No." MaxLength="10" AutoComplete="off" />
                        ...
                        <asp:GridView ID="GvReport" runat="server" AutoGenerateColumns="false" UseAccessibleHeader="true" HeaderStyle-CssClass="thead" EmptyDataText="No records available. Please refine your search.">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Commission">
                                    <ItemTemplate>
                                        <%# Eval("CommissionType").ToString() == "Percantage" ? Eval("CommissionPercentage") + " %" : "Rs. " + Eval("CommissionValue")%>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                        ...
                                        <div class="plan-card">
                                            <a href="RegistrationDetails.aspx?qe=<%# Eval("skuandserialno") %>">
                                                ...
                                                <div class="container-fluid mb-2 px-3 d-flex gap-1 flex-column mt-0">
                                                    ...
                                                    <div class="row mb-0">
                                                        <div class="col-12 plan-name-txt">Plan Valid From: 
                                                            ...
                                                            <strong style='<%# GetPlanStatusBackground(Eval("sdpDate").ToString()) %>'> <%# Eval("sdpDate") %> </strong> </div>
                                                    </div>
                                                    <div class="row mb-0">
                                                        <div class="col-12 plan-name-txt">IMEI No/Serial No:
                                                    ...
                                                    <div class="row d-flex justify-content-between px-3">
                                                        <div class="plan-name-txt">Loan No:<strong> <%# Eval("LoanNo") %> </strong></div>
                                                            <asp:LinkButton ID="lnkCardClaim" runat="server"  CssClass="eye-icon" OnClick="RegistrationDetails" ToolTip='<%#Bind("skuandserialno")%>'
