    ...
    <div class="container-fluid  dashboard-content">
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <div class="btn-group">
                        <a class="btn btn-primary" href="CreateSalesPerson.aspx"><i class="fa fa-list"></i> &nbsp  Add Sales Person</a>
                    </div>
                    <div class="card-body">
                            ...
                            <asp:GridView ID="GvSalePerson" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered text-nowrap"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Actions">
                                        <ItemTemplate>
                                            <a href='CreateSalesPerson.aspx?Mid=<%# Eval("MId") %>' class="btn btn-sm btn-primary me-1" title="Edit">
                                                <i class="fa fa-edit"></i>
                                            </a>

                                            <!-- Delete Icon Button -->
                                            <asp:LinkButton ID="lnkDelete" runat="server" CommandName="DeleteRow" CommandArgument='<%# Eval("MId") %>'
                                                CssClass="btn btn-sm btn-danger" OnClientClick="return confirm('Are you sure you want to delete this profile?');">
