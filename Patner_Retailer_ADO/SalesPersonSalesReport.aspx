...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="card">
        <div class="card-body">
            <h4 class="filter-txt">Sales Executive Wise Report</h4>
            <div class="row justify-content-start mb-3">
                <div class="col-12 col-lg-10">
                    <div class="row">
                        <div class="col-12 col-lg-2 pr-0 mb-2 mb-lg-0">
                            <asp:TextBox ID="txtSalesPersonName" runat="server" CssClass="form-control" placeholder="Sales Executive Name"></asp:TextBox>
                        </div>
                        <div class="col-12 col-lg-2 pr-0 mb-3 mb-lg-0">
                            <asp:TextBox ID="txtSalesPersonMobile" runat="server" CssClass="form-control" placeholder="Sales Executive Mobile No"></asp:TextBox>
                        </div>
                        <div class="col-12 col-lg-2 pr-0 mb-2 mb-lg-0">
            ...
            <div>
                <asp:GridView ID="GvSalesReports" runat="server" AutoGenerateColumns="false" UseAccessibleHeader="true" HeaderStyle-CssClass="thead" EmptyDataText="No records available. Please refine your search.">
                    <Columns>
                        ...
                        <asp:BoundField DataField="SalesPersonName" HeaderText="Sales Executive Name" />
                        <asp:BoundField DataField="SalesPersonMobileNo" HeaderText="Sales Executive Mobile No" />
                        <asp:BoundField DataField="SalesPersonEmailIDAddress" HeaderText="Sales Executive Email Id" />
