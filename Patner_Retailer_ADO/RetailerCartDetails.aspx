<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RetailerCartDetails.aspx.cs" Inherits="Patner_Retailer_ADO.RetailerCartDetails" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Retailer Cart Details</title>
    <meta charset="utf-8">
                        ...
                        <div class="card-body" style="display: flex;">
                            <div class="col-md-8">
                                ...
                                <asp:Repeater ID="rptPlans" runat="server">
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblPlanName" runat="server" Text='<%# Eval("Productname") %>'></asp:Label></td>
                                            <td>
                                                <asp:Label ID="lblDevicePurchasePrice" runat="server" Text='<%# Eval("DevicePurchasePrice") %>'></asp:Label></td>
                                            <td><%# Eval("PlanName") %></td>
                                            <td>
                                                <asp:Label ID="lblQuantity" runat="server" Text='<%# Eval("Quantity") %>'></asp:Label></td>
                                            <td>
                                                <asp:Label ID="lblPlanPrice" runat="server" Text='<%# Eval("PlanPrice") %>'></asp:Label></td>
                                            <td>
                            ...
                            <div class="col-md-4">
                                <div class="card bg-light mb-3">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center mb-2">Total Item : <strong>
                                            <p id="txtQuantity" runat="server"></p>
                                        </strong></div>
                                        <div class="d-flex justify-content-between align-items-center mb-2">Taxable Value:<strong><p id="TaxableValue" runat="server"></p>
                                        </strong></div>
                                        <div class="d-flex justify-content-between align-items-center mb-2">GST(18%) :<strong><p id="TaxAmout" runat="server"></p>
                                        </strong></div>
                                        <hr />
                                        <div class="d-flex justify-content-between align-items-center">Total Net Value (Including Tax):<strong><p id="TotalAmountPay" runat="server"></p>
                                        </strong></div>
                                    </div>
                                </div>
                            </div>
