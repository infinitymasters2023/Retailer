                                                ...
                                                <ul class="nav nav-tabs" role="tablist">
                                                    <li role="presentation" class="active">
                                                        <a href="#step1" data-toggle="tab" aria-controls="step1" role="tab"
                                                            aria-expanded="false"><span class="round-tab"></span><i>Personal
                                                                Info</i>
                                                        </a>
                                                    </li>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group mb-3  position-relative">
                                                                    <label class="mb-1">Date of Birth  <span style="color: red">*</span> </label>
                                                                    <%--<asp:TextBox runat="server" CssClass="form-control" ID="TextBox1" placeholder="" TextMode="Date">
                                                                    </asp:TextBox>--%>
