<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="RequestfromSalesperson.aspx.cs" Inherits="Patner_Retailer_ADO.RequestfromSalesperson" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="card mb-3">
        <div class="card-body">
            <h5 class="card-header mb-3" style="display: flex; justify-content: space-between; padding-top: 0px !important; padding-left: 0px !important;">Request from Sales Executive</h5>
                    ...
                    <asp:View ID="viewList" runat="server">
                        <asp:GridView ID="GvReport" runat="server" AutoGenerateColumns="false" UseAccessibleHeader="true" HeaderStyle-CssClass="thead" EmptyDataText="No records available. Please refine your search." BorderStyle="None">
                            <Columns>
                                ...
                                <asp:BoundField DataField="RetailerName" HeaderText="Sales Executive Name" />
                                <asp:BoundField DataField="RetailerMobileNo" HeaderText="Sales Executive Mobile No" />
                                    ...
                                    <%--<div class="col-lg-4 col-12 mb-3">--%>
                                        <div class="plan-card">
                                            ...
                                            <div class="container-fluid mb-2 px-3 d-flex gap-1 flex-column mt-0">
                                                ...
                                                <div class="row mb-0">
                                                    <div class="col-12 plan-name-txt">Sales Executive Name: <span class="fw-600"><%# Eval("RetailerName") %> </span></div>
                                                </div>
                                                <div class="row mb-0">
                                                    <div class="col-12 plan-name-txt">Sales Executive Mobile No: <span class="fw-600"><%# Eval("RetailerMobileNo") %> </span></div>
                                                </div>
                                                <div class="backToCartcls">
                                                    <asp:LinkButton ID="backToCart"  Visible='<%# !(Session["Role"] != null && Session["Role"].ToString() == "Agent") %>'
                                                        runat="server" CommandName="BackToCart" CommandArgument='<%# Eval("incMid") %>'>
