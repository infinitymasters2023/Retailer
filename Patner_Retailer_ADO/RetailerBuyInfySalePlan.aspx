<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RetailerBuyInfySalePlan.aspx.cs" Inherits="Patner_Retailer_ADO.RetailerBuyInfySalePlan" %>
...
<head  runat="server">
    ...
    <script>
        ...
        function validateMobileNo() {
            ...
            if (!/^\d{0,10}$/.test(mobileNo)) {
                document.getElementById("txtCustomerMobile").value = mobileNo.slice(0, -1);
            }
        }
        ...
        (function () {
            $("#ContentPlaceHolder1_txtPurchaseDate").datepicker({
                dateFormat: "dd/mm/yy"
            });
        });
    </script>
    ...
    <script type="text/javascript">
        function validateIMEI() {
            const imeiInput = document.getElementById('ContentPlaceHolder1_txtimeiNo');
