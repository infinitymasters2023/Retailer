    ...
    <div class="container-fluid  dashboard-content">
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="filter-txt">Claim Reports</h4>
                        <div class="row justify-content-start mb-3">
                            ...
                            <div class="col-12 col-lg-2 pr-0">
                                <div class="d-flex justify-content-between gap-2">
                                    <asp:Button ID="btnSubmit" runat="server" Text="Submit" CssClass="btn btn-success" Style="font-size: 12px;"  OnClick="SubmitReport" />
                                    <asp:Button ID="btnExportExcel" runat="server" Text="Excel to Excel" CssClass="btn btn-info" OnClick="btnExportExcel_Click" Style="font-size: 12px;" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive">
                            <asp:GridView ID="GvClaimReport" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered text-nowrap">
                                <Columns>
