<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ReportedClaims.aspx.cs" Inherits="Patner_Retailer_ADO.ReportedClaims" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    right: 20px;
     ...
     .eye-icon a{
        ...
        #ContentPlaceHolder1_GvClaimReport_filter {
            display: none;
        }

        #ContentPlaceHolder1_GvClaimReport_length {
            display: none;
        }
    ...
    <script>
        setTimeout(function () {
            const rows = document.querySelectorAll('#ContentPlaceHolder1_GvClaimReport_wrapper .row');
            if (rows.length > 1) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="card mb-3">
        <div class="card-body pb-3">
            <h5 class="card-header mb-3" style="display: flex; justify-content: space-between; padding-top: 0px !important; padding-left: 0px !important;">Product Registration Reports</h5>
                        ...
                        <asp:GridView ID="GvClaimReport" runat="server" AutoGenerateColumns="false" UseAccessibleHeader="true" HeaderStyle-CssClass="thead" EmptyDataText="No records available. Please refine your search." BorderStyle="None">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="View Ticket">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkClaim" runat="server" OnClick="RegisterClaim" ToolTip='<%#Bind("skuandserialno")%>'
                                            CommandArgument='<%# Eval("skuandserialno") %>' Text="View">
                                   <i class="fa fa-sign-in-alt" aria-hidden="true" style="font-size: large;"></i>
                                        </asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="Status" HeaderText="Registration Status" />
                                <asp:BoundField DataField="skuandserialno" HeaderText="InfyShield No" />
                                        ...
                                        <a href="ClaimList.aspx?sku=<%# Eval("skuandserialno") %>">
                                            ...
                                            <div class="container-fluid mb-2 px-3 d-flex gap-1 flex-column mt-0">
                                                ...
                                                <div class="row d-flex justify-content-between px-3">
                                                    ...
                                                    <asp:LinkButton ID="lnkCardClaim" CssClass="eye-icon" runat="server" OnClick="RegisterClaim" ToolTip='<%#Bind("skuandserialno")%>'
                                                        CommandArgument='<%# Eval("skuandserialno") %>' Text="View">
